...
CREATE TABLE Cart(ID INT IDENTITY(1,1) PRIMARY KEY, UserID INT, BookID INT, UnitPrice DECIMAL(18,2), Discount DECIMAL(18,2), Quantity INT, TotalPrice DECIMAL(18,2));
